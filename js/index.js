...
document.addEventListener("DOMContentLoaded", function () {
  const linkSubpage = document.querySelector(".container-img-and-text-one");
...
document.addEventListener("DOMContentLoaded", function () {
  const linkSubpage = document.querySelector(".container-img-and-text-two");
  const mainElement = document.querySelector("main");
  const footerElement = document.querySelector("footer");
...
document.addEventListener("DOMContentLoaded", function () {
  const linkSubpage = document.querySelector(".container-img-and-text-three");
  const mainElement = document.querySelector("main");
  const footerElement = document.querySelector("footer");
  ...
  linkSubpage.addEventListener("click", (event) => {
    ...
    // Navigiere zur Seite "things-we-write.html" nach einer Sekunde
    setTimeout(() => {
      window.location.href = "calender-collection.html";
    }, 500);
  });
});
